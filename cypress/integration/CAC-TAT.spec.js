...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('campo telefone continua vazio quando digitado um valor nao-numerico', function(){
        cy.get('#phone')
        .type('abcdefghij')
        .should('have.value', '')
    })
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone',function(){
        cy.get('#firstName').type('Ian')
        .should('have.value', 'Ian').clear().should('have.value', '')
        cy.get('#lastName').type('Vidal')
        .should('have.value', 'Vidal').clear().should('have.value', '')
        cy.get('#email').type('ianvidal@live.com')
        .should('have.value', 'ianvidal@live.com').clear().should('have.value', '')
        cy.get('#phone-checkbox').click()
        cy.get('#phone').type('85981880011')
        .should('have.value', '85981880011').clear().should('have.value', '')
        cy.get('#open-text-area').type('teste')
